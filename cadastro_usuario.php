...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($usuario) || empty($email) || empty($senha) || empty($confirmar_senha)) {
        ...
        $stmt = mysqli_prepare($mysqli, "SELECT id FROM usuarios WHERE usuario = ?");
        ...
        if (mysqli_stmt_num_rows($stmt) > 0) {
            ...
            $stmt_email = mysqli_prepare($mysqli, "SELECT id FROM usuarios WHERE email = ?");
            ...
            if (mysqli_stmt_num_rows($stmt_email) > 0) {
                ...
                $stmt_insert = mysqli_prepare($mysqli, "INSERT INTO usuarios (usuario, email, senha) VALUES (?, ?, ?)");
...
<head>
    <meta charset="UTF-8">
    <title>CineAdmin - Cadastro de Usuário</title>
...
<body>
    ...
    <main class="auth-container">
        <div class="auth-box">
            <h1 class="auth-title">Cadastrar Usuário</h1>
            ...
            <form class="auth-form" method="POST">
                ...
                <div class="form-group password-group">
                    ...
                    <span class="eye-icon" onclick="mostrarSenha('senha')"><i class="fas fa-eye"></i></span>
                </div>

                <div class="form-group password-group">
                    <input type="password" id="confirmar_senha" name="confirmar_senha" required>
                    <label for="confirmar_senha">Confirmar Senha</label>
                    <span class="eye-icon" onclick="mostrarSenha('confirmar_senha')"><i class="fas fa-eye"></i></span>
                </div>
            ...
            <div class="auth-switch">
                <p>Já tem uma conta? <a href="login_usuario.php">Faça login</a>.</p>
            </div>
        </div>
    </main>
